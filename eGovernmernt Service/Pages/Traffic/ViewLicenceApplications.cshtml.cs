...
namespace eGovernmernt_Service.Pages.Traffic
{
    ...
    public class ViewApplicationsModel : PageModel
    {
        ...
        [BindProperty]
        public TrafficLicenceApplication Record { get; set; }

        public IActionResult OnGet(int id)
        {
            Record = context.TrafficLicenceApplication.FirstOrDefault(r => r.AppID == id);
            if (Record == null)
            {
                return NotFound();
            }
        ...
        public IActionResult OnPost()
        {
            ...
            var recordInDb = context.TrafficLicenceApplication.FirstOrDefault(r => r.AppID == Record.AppID);
            if (recordInDb == null)
            {
                return NotFound();
            }
